...
con=oc.connect('system/mkv@localhost')      #Your Account Name and password
coursor=con.cursor()
...
def Home():
    ...
    def validte():
        # print(Id.get(),type(Id.get()))
        if Id.get()==0 or Id.get()=="":
...
def delivery():
    ...
    Button1.place(x=790, y=800,height=40)
    Button1.configure(foreground="#161B21",background="#F4A950",relief = 'flat',font=('Helvetica', 34),text='''Back''')
...
def terms_condition():
    ...
    Button1.configure(background="#F4A950",foreground="#161B21",relief = 'flat',font=('Helvetica', 34),text='''Back''')
